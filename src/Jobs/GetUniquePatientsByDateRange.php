...
class GetUniquePatientsByDateRange implements ShouldQueue
{
    ...
    {
        Log::error('GetUniquePatientsByDateRange job failed completely', [
    ...
    public function handle(
        AppointmentRepositoryInterface $appointmentRepository,
            ...
            // Consultar pacientes únicos directamente desde el repositorio
            ...
            // Despachar job individual para cada paciente único
            $jobsDispatched = 0;
            ...
            Log::info('WHATSAPP_MESSAGES_FLOW_SUMMARY', [
