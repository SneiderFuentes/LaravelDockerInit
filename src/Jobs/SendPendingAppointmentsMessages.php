...
class SendPendingAppointmentsMessages implements ShouldQueue
{
    ...
    {
        Log::error('SendPendingAppointmentsMessages job failed completely', [
    ...
    public function handle(): void {
        ...
        // Ejecutar directamente el job que consulta IDs de pacientes únicos PENDIENTES
        \Core\Jobs\GetUniquePendingPatientsByDateRange::dispatch(
            $centerKey,
            $startDate,
            $endDate
